...
export default function Invitation() {
  return (
    <div className="relative flex h-screen flex-col items-center justify-center bg-[url(/assets/background.webp)] bg-cover">
      <img
      ...
      />
      <div className="flex h-screen max-h-[874px] max-w-[402px] flex-col items-center pt-8">
